...
theme.tasklist_font                             = "Cascadia Code 11"
...
local bat = lain.widget.bat({
    ...
    settings = function()
		...
		-- default setup of widget
                widget:set_markup(markup.font(theme.font, markup.fg.color("#ffffff", bat_now.perc .. "% [" .. bat_now.time .. "]")))
        else
            --theme.batcolor = "#e35d6a"
...
function theme.connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 24, bg = theme.bg_normal .. '00', fg = theme.fg_normal })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.margin(wibox.widget { kbdwidget, layout = wibox.layout.align.horizontal }, 1, 1),
            wibox.container.margin(wibox.widget { vol_icon, volume_widget, layout = wibox.layout.align.horizontal }, 1, 1),
            wibox.container.margin(wibox.widget { fs_icon, theme.fs.widget, layout = wibox.layout.align.horizontal }, 1, 1),
            wibox.container.margin(wibox.widget { temp_icon, temp.widget, layout = wibox.layout.align.horizontal }, 1, 1), 
            wibox.container.margin(wibox.widget { cpu_icon, cpu.widget, layout = wibox.layout.align.horizontal }, 1, 1),
            wibox.container.margin(wibox.widget { mem_icon, mem.widget, layout = wibox.layout.align.horizontal }, 1, 1),
            wibox.container.margin(wibox.widget { bat_icon, bat_widget, bat.widget, layout = wibox.layout.align.horizontal }, 1, 1),
            wibox.container.margin(wibox.widget {clock_widget, layout = wibox.layout.align.horizontal }, 1, 1),
            s.mylayoutbox,
        },
    }
end
