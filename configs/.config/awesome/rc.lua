...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "l", function() awful.util.spawn(i3lock_settings) end),
    awful.key({                   }, "Print", function() awful.util.spawn("scrot -e 'mv %f ~/screenshots/'") end),
    awful.key({ }, "F3", function () scratch.drop(terminal .. " -e nnn", "center", "center", 0.75, 0.7, true, mouse.screen) end),

    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.spawn(terminal .. " -e tmux new -A -s base") end,
