...
import { AIDevtoolsEventSource, AIDevtoolsEventVisibility } from './envelope.js';
export type { AIDevtoolsEventEnvelope, AIDevtoolsEventEnvelopeInput, AIDevtoolsEventSource, AIDevtoolsEventVisibility, } from './envelope.js';
export { createAIDevtoolsEventEnvelope, getAIDevtoolsDedupeKey, getAIDevtoolsRuntimeId, } from './envelope.js';
...
export type MessagePart = TextPart | ImagePart | AudioPart | VideoPart | DocumentPart | ToolCallPart | ToolResultPart | ThinkingPart | StructuredOutputPart;
 ...
 */
export type BillingUnit = 'tokens' | 'seconds' | 'characters' | 'images' | 'videos' | 'megapixels' | 'requests' | 'units' | (string & {});
/**
...
export interface RunLifecycleEvent extends BaseEventContext {
    ...
    threadId?: string;
    runId: string;
    status: 'created' | 'started' | 'updated' | 'completed' | 'errored' | 'cancelled';
    error?: string;
}
...
export declare function emitAIDevtoolsEvent<TEvent extends keyof AIDevtoolsEventMap & string>(eventName: TEvent, payload: AIDevtoolsEventMap[TEvent]): void;
export declare function dispatchAIDevtoolsEvent<TEvent extends keyof AIDevtoolsEventMap & string>(eventName: TEvent, payload: AIDevtoolsEventMap[TEvent]): void;
