 ...
 */
type InferFactoryModels<TFactory> = TFactory extends (model: infer TModel, ...args: Array<never>) => unknown ? TModel extends string ? TModel : string : string;
/**
 * Infer the adapter return type from a factory function.
 */
type InferAdapterReturn<TFactory> = TFactory extends (...args: Array<never>) => infer TReturn ? TReturn : never;
/**
 ...
 */
type InferRestArgs<TFactory extends AnyAdapterFactory> = Parameters<TFactory> extends [unknown?, ...infer TRest] ? TRest : [];
/**
 ...
 */
type ExtendedFactory<TFactory extends AnyAdapterFactory, TDefs extends ReadonlyArray<ExtendedModelDef>> = (model: InferFactoryModels<TFactory> | ExtractCustomModelNames<TDefs>, ...args: InferRestArgs<TFactory>) => InferAdapterReturn<TFactory>;
/**
 ...
 * ```
 */
export declare function extendAdapter<TFactory extends AnyAdapterFactory, const TDefs extends ReadonlyArray<ExtendedModelDef>>(factory: TFactory, _customModels: TDefs): ExtendedFactory<TFactory, TDefs>;
export {};
