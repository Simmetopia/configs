 ...
 */
export type GenerationActivity = 'chat' | 'image' | 'video' | 'audio' | 'tts' | 'transcription' | 'embedding' | 'rerank' | 'summarize';
/**
 ...
 */
export type GenerationResultTransform<TResult = unknown, TContext = unknown> = (result: TResult, ctx: GenerationResultTransformContext<TContext>) => TResult | undefined | Promise<TResult | undefined>;
/**
