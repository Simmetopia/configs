...
//#region src/middlewares/usage-attributes.ts
/**
...
function usageAttributes(usage) {
	...
	const optional = [
		...
		["tanstack.ai.usage.upstream_input_cost", usage.costDetails?.upstreamInputCost],
		["tanstack.ai.usage.upstream_output_cost", usage.costDetails?.upstreamOutputCost]
	];
