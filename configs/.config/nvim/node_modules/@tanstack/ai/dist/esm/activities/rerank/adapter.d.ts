import { RerankAdapterResult, RerankOptions } from '../../types.js';
/**
 ...
 */
export interface RerankAdapter<TModel extends string = string, TProviderOptions extends object = Record<string, unknown>> {
     ...
     */
    rerank: (options: RerankOptions<TProviderOptions>) => Promise<RerankAdapterResult>;
}
/**
 ...
 */
export declare abstract class BaseRerankAdapter<TModel extends string = string, TProviderOptions extends object = Record<string, unknown>> implements RerankAdapter<TModel, TProviderOptions> {
    readonly kind: "rerank";
    ...
    constructor(config: RerankAdapterConfig | undefined, model: TModel);
    abstract rerank(options: RerankOptions<TProviderOptions>): Promise<RerankAdapterResult>;
