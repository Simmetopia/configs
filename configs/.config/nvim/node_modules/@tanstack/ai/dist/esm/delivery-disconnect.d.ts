 ...
 * @internal
 */
export declare function publishRunDisconnectHandler(stream: object, onDisconnect: () => void): void;
/**
 ...
 * @internal
 */
export declare function notifyRunDisconnected(stream: unknown): void;
